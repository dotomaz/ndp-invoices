...
export type CreateInvoiceMutation = { __typename?: "Mutation" } & {
  createInvoice: Maybe<{ __typename?: "Invoice" } & Pick<Invoice, "id">>;
};

export type CreateInvoicePeriodMutationVariables = {
  input: InvoicePeriodInput;
};

export type CreateInvoicePeriodMutation = { __typename?: "Mutation" } & {
  createInvoicePeriod: Maybe<
    { __typename?: "InvoicePeriod" } & Pick<InvoicePeriod, "id">
  >;
};

export type DeleteInvoiceMutationMutationVariables = {
  id: Scalars["ID"];
};

export type DeleteInvoiceMutationMutation = { __typename?: "Mutation" } & {
  deleteInvoice: Maybe<{ __typename?: "Invoice" } & Pick<Invoice, "id">>;
};

export type DeleteInvoicePeriodMutationMutationVariables = {
  id: Scalars["ID"];
};
...
export type GetInvoicePeriodsQueryVariables = {
  page: Scalars["Int"];
};

export type GetInvoicePeriodsQuery = { __typename?: "Query" } & {
  invoice_periods: Maybe<
    { __typename?: "InvoicePeriodPaginator" } & {
      data: Array<
        { __typename?: "InvoicePeriod" } & Pick<
          InvoicePeriod,
          "id" | "month" | "year"
        >
      >;
...
export type InitQueryVariables = {
  page: Scalars["Int"];
};

export type InitQuery = { __typename?: "Query" } & {
  invoice_periods: Maybe<
    { __typename?: "InvoicePeriodPaginator" } & {
      data: Array<
        { __typename?: "InvoicePeriod" } & Pick<
...
export type LoadInvoiceQueryVariables = {
  id: Scalars["ID"];
};

export type LoadInvoiceQuery = { __typename?: "Query" } & {
  invoice: Maybe<
...
export type UpdateInvoiceMutation = { __typename?: "Mutation" } & {
  updateInvoice: Maybe<{ __typename?: "Invoice" } & Pick<Invoice, "id">>;
};

export type UpdateInvoicePeriodMutationMutationVariables = {
  id: Scalars["ID"];
  input: InvoicePeriodInput;
};
